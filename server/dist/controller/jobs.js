...
class JobsController {
    ...
    static getAllJobForEmployeer(pn, id) {
        return (0, rxjs_1.of)(true).pipe((0, operators_1.mergeMap)(() => (0, rxjs_1.from)(jobs_2.default.find({ createdBy: id }).skip((pn - 1) * 10).limit(10).populate({ path: "applications rejected", select: ["-password"] }))), (0, operators_1.mergeMap)((m) => {
    ...
    static getAllJobs(pn) {
        return (0, rxjs_1.of)(true).pipe((0, operators_1.mergeMap)(() => (0, rxjs_1.from)(jobs_2.default.find({ status: "open" }).skip((pn - 1) * 10).limit(10).populate({ path: "createdBy", select: ["-password"] }).sort({ _id: -1 }))), (0, operators_1.mergeMap)((m) => {
            return (0, rxjs_1.forkJoin)([
                (0, rxjs_1.of)(m),
    ...
    static applyForJob(jobid, aplicationId) {
        console.log(jobid, aplicationId);
